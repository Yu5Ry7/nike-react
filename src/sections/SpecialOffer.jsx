  ...
  return (
    ...
    max-container">
      ...
      <div className="felx-1">
        <img className="object-contain w-full" src={offer} 
        width ={773}
        height={687}
        alt="image" />
      </div>
      ...
      text-coral-red
       "> Offer</span>
        ...
        <p className="mt-6
        lg:max-w-lg
        info-text">Navigate a realm of possibilities designed to fulfill your unique desires, surpassing the loftiest expectations.
